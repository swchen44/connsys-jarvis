...
type: knowhow
scope: {expert-name}
tags: [{domain}, identity, methodology, constraints, using-knowhow]
---
...
Simplify both soul.md and expert.md to HTML comments:
...
<!-- 
  ...
  Content has been migrated to {expert-name}-using-knowhow skill.
